...
static inline int hiae_constant_time_compare(const uint8_t *a, const uint8_t *b, size_t len)
{
...
static inline SoftAesBlock softaes_block_zero(void)
{
    const SoftAesBlock out = { 0, 0, 0, 0 };
    return out;
}

static inline SoftAesBlock softaes_block_load(const uint8_t in[16])
{
...
static inline void softaes_block_store(uint8_t out[16], const SoftAesBlock in)
{
...
static inline SoftAesBlock softaes_block_xor(const SoftAesBlock a, const SoftAesBlock b)
{
    const SoftAesBlock out = { a.w0 ^ b.w0, a.w1 ^ b.w1, a.w2 ^ b.w2, a.w3 ^ b.w3 };
    return out;
}

static inline SoftAesBlock softaes_block_and(const SoftAesBlock a, const SoftAesBlock b)
{
    const SoftAesBlock out = { a.w0 & b.w0, a.w1 & b.w1, a.w2 & b.w2, a.w3 & b.w3 };
    return out;
}
...
static SoftAesBlock _encrypt(const uint8_t ix0[4], const uint8_t ix1[4], const uint8_t ix2[4],
                             const uint8_t ix3[4])
{
    SoftAesBlock out;
...
static inline SoftAesBlock softaes_block_aesl(const SoftAesBlock block)
{
...
static inline SoftAesBlock softaes_block_xaesl(SoftAesBlock block, const SoftAesBlock prk)
{
    block.w0 ^= prk.w0;
    block.w1 ^= prk.w1;
    block.w2 ^= prk.w2;
...
static inline void hiae_software_update_state_offset(hiae_software_DATA128b *state,
                                                     hiae_software_DATA128b *tmp,
                                                     hiae_software_DATA128b M, int offset)
{
    ...
    state[(0 + offset) % STATE] =
        hiae_software_SIMD_XOR(tmp[offset], hiae_software_AESL(state[(P_4 + offset) % STATE]));
...
{
    hiae_software_DATA128b tmp =
        hiae_software_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    M = hiae_software_SIMD_XOR(hiae_software_SIMD_XOR(tmp, M), state[(P_7 + offset) % STATE]);
    return M;
}

static inline hiae_software_DATA128b hiae_software_enc_offset(hiae_software_DATA128b *state,
                                                              hiae_software_DATA128b M, int offset)
{
    hiae_software_DATA128b C =
        hiae_software_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    C = hiae_software_SIMD_XOR(C, M);
    state[(0 + offset) % STATE] =
        hiae_software_SIMD_XOR(C, hiae_software_AESL(state[(P_4 + offset) % STATE]));
...
static inline hiae_software_DATA128b hiae_software_dec_offset(hiae_software_DATA128b *state,
                                                              hiae_software_DATA128b *tmp,
                                                              hiae_software_DATA128b C, int offset)
{
    tmp[offset] = hiae_software_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    hiae_software_DATA128b M = hiae_software_SIMD_XOR(state[(P_7 + offset) % STATE], C);
    state[(0 + offset) % STATE] =
        hiae_software_SIMD_XOR(M, hiae_software_AESL(state[(P_4 + offset) % STATE]));
...
#define hiae_software_LOAD_1BLOCK_offset_enc(M, offset) \
    (M) = hiae_software_SIMD_LOAD(mi + i + 0 + BLOCK_SIZE * offset);
#define hiae_software_LOAD_1BLOCK_offset_dec(C, offset) \
    (C) = hiae_software_SIMD_LOAD(ci + i + 0 + BLOCK_SIZE * offset);
#define hiae_software_LOAD_1BLOCK_offset_ad(M, offset) \
    (M) = hiae_software_SIMD_LOAD(ad + i + 0 + BLOCK_SIZE * offset);
#define hiae_software_STORE_1BLOCK_offset_enc(C, offset) \
    hiae_software_SIMD_STORE(ci + i + 0 + BLOCK_SIZE * offset, (C));
#define hiae_software_STORE_1BLOCK_offset_dec(M, offset) \
    hiae_software_SIMD_STORE(mi + i + 0 + BLOCK_SIZE * offset, (M));

static inline void hiae_software_state_shift(hiae_software_DATA128b *state,
                                             hiae_software_DATA128b *tmp)
{
    tmp[0]    = state[0];
    state[0]  = state[1];
...
static inline void hiae_software_ad_update(hiae_software_DATA128b *state,
                                           hiae_software_DATA128b *tmp, const uint8_t *ad, size_t i)
{
...
static inline void hiae_software_encrypt_chunk(hiae_software_DATA128b *state, const uint8_t *mi,
                                               uint8_t *ci, size_t i)
{
...
static inline void hiae_software_decrypt_chunk(hiae_software_DATA128b *state,
                                               hiae_software_DATA128b *tmp, const uint8_t *ci,
                                               uint8_t *mi, size_t i)
{
    hiae_software_DATA128b M[16], C[16];
...
static void HiAE_init_software(HiAE_state_t *state_opaque, const uint8_t *key, const uint8_t *nonce)
{
...
static void HiAE_absorb_software(HiAE_state_t *state_opaque, const uint8_t *ad, size_t len)
{
    hiae_software_DATA128b state[STATE];
...
static void HiAE_finalize_software(HiAE_state_t *state_opaque, uint64_t ad_len, uint64_t msg_len,
                                   uint8_t *tag)
{
    hiae_software_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_enc_software(HiAE_state_t *state_opaque, uint8_t *ci, const uint8_t *mi,
                              size_t size)
{
    hiae_software_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_dec_software(HiAE_state_t *state_opaque, uint8_t *mi, const uint8_t *ci,
                              size_t size)
{
    hiae_software_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_enc_partial_noupdate_software(HiAE_state_t  *state_opaque,
                                               uint8_t       *ci,
                                               const uint8_t *mi,
                                               size_t         size)
{
...
static void HiAE_dec_partial_noupdate_software(HiAE_state_t  *state_opaque,
                                               uint8_t       *mi,
                                               const uint8_t *ci,
                                               size_t         size)
{
...
static int HiAE_encrypt_software(const uint8_t *key,
                                 const uint8_t *nonce,
                                 const uint8_t *msg,
                                 uint8_t       *ct,
                                 size_t         msg_len,
...
static int HiAE_decrypt_software(const uint8_t *key,
                                 const uint8_t *nonce,
                                 uint8_t       *msg,
                                 const uint8_t *ct,
                                 size_t         ct_len,
...
static int HiAE_mac_software(const uint8_t *key, const uint8_t *nonce, const uint8_t *data,
...
static inline void hiae_aesni_update_state_offset(hiae_aesni_DATA128b *state,
                                                  hiae_aesni_DATA128b *tmp, hiae_aesni_DATA128b M,
                                                  int offset)
{
...
static inline hiae_aesni_DATA128b hiae_aesni_keystream_block(hiae_aesni_DATA128b *state,
                                                             hiae_aesni_DATA128b *tmp,
                                                             hiae_aesni_DATA128b M, int offset)
{
    tmp[offset] = hiae_aesni_SIMD_XOR(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
...
static inline hiae_aesni_DATA128b hiae_aesni_enc_offset(hiae_aesni_DATA128b *state,
                                                        hiae_aesni_DATA128b M, int offset)
{
    hiae_aesni_DATA128b C =
        hiae_aesni_SIMD_XOR(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
...
static inline hiae_aesni_DATA128b hiae_aesni_dec_offset(hiae_aesni_DATA128b *state,
                                                        hiae_aesni_DATA128b *tmp,
                                                        hiae_aesni_DATA128b C, int offset)
{
    tmp[offset] = hiae_aesni_SIMD_XOR(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
...
#define hiae_aesni_LOAD_1BLOCK_offset_enc(M, offset) \
    (M) = hiae_aesni_SIMD_LOAD(mi + i + 0 + BLOCK_SIZE * offset);
#define hiae_aesni_LOAD_1BLOCK_offset_dec(C, offset) \
    (C) = hiae_aesni_SIMD_LOAD(ci + i + 0 + BLOCK_SIZE * offset);
#define hiae_aesni_LOAD_1BLOCK_offset_ad(M, offset) \
    (M) = hiae_aesni_SIMD_LOAD(ad + i + 0 + BLOCK_SIZE * offset);
#define hiae_aesni_STORE_1BLOCK_offset_enc(C, offset) \
    hiae_aesni_SIMD_STORE(ci + i + 0 + BLOCK_SIZE * offset, (C));
#define hiae_aesni_STORE_1BLOCK_offset_dec(M, offset) \
    hiae_aesni_SIMD_STORE(mi + i + 0 + BLOCK_SIZE * offset, (M));

static inline void hiae_aesni_state_shift(hiae_aesni_DATA128b *state)
{
...
static inline void hiae_aesni_ad_update(hiae_aesni_DATA128b *state, hiae_aesni_DATA128b *tmp,
                                        hiae_aesni_DATA128b *M, const uint8_t *ad, size_t i)
{
...
static inline void hiae_aesni_encrypt_chunk(hiae_aesni_DATA128b *state, hiae_aesni_DATA128b *M,
                                            hiae_aesni_DATA128b *C, const uint8_t *mi, uint8_t *ci,
                                            size_t i)
{
...
static inline void hiae_aesni_decrypt_chunk(hiae_aesni_DATA128b *state,
                                            hiae_aesni_DATA128b *tmp,
...
static void HiAE_init_aesni(HiAE_state_t *state_opaque, const uint8_t *key, const uint8_t *nonce)
{
...
static void HiAE_absorb_aesni(HiAE_state_t *state_opaque, const uint8_t *ad, size_t len)
{
    hiae_aesni_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t              i      = 0;
...
static void HiAE_finalize_aesni(HiAE_state_t *state_opaque, uint64_t ad_len, uint64_t msg_len,
                                uint8_t *tag)
{
    hiae_aesni_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_enc_aesni(HiAE_state_t *state_opaque, uint8_t *ci, const uint8_t *mi, size_t size)
{
    hiae_aesni_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t rest   = size % UNROLL_BLOCK_SIZE;
...
static void HiAE_dec_aesni(HiAE_state_t *state_opaque, uint8_t *mi, const uint8_t *ci, size_t size)
{
    hiae_aesni_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t rest   = size % UNROLL_BLOCK_SIZE;
...
static void HiAE_enc_partial_noupdate_aesni(HiAE_state_t  *state_opaque,
                                            uint8_t       *ci,
                                            const uint8_t *mi,
                                            size_t         size)
{
...
static void HiAE_dec_partial_noupdate_aesni(HiAE_state_t  *state_opaque,
                                            uint8_t       *mi,
                                            const uint8_t *ci,
                                            size_t         size)
{
...
static int HiAE_encrypt_aesni(const uint8_t *key,
                              const uint8_t *nonce,
                              const uint8_t *msg,
                              uint8_t       *ct,
                              size_t         msg_len,
...
static int HiAE_decrypt_aesni(const uint8_t *key,
                              const uint8_t *nonce,
                              uint8_t       *msg,
                              const uint8_t *ct,
                              size_t         ct_len,
...
static int HiAE_mac_aesni(const uint8_t *key, const uint8_t *nonce, const uint8_t *data,
                          size_t data_len, uint8_t *tag)
{
    HiAE_state_t state;
    HiAE_init_aesni(&state, key, nonce);
...
static inline void hiae_vaes_avx512_update_state_offset(hiae_vaes_avx512_DATA128b *state,
                                                        hiae_vaes_avx512_DATA128b *tmp,
                                                        hiae_vaes_avx512_DATA128b M, int offset)
{
    tmp[offset] =
        hiae_vaes_avx512_SIMD_XOR(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    tmp[offset] = hiae_vaes_avx512_AESENC(tmp[offset], M);
    state[(0 + offset) % STATE] =
        hiae_vaes_avx512_AESENC(state[(P_4 + offset) % STATE], tmp[offset]);
...
hiae_vaes_avx512_keystream_block(hiae_vaes_avx512_DATA128b *state, hiae_vaes_avx512_DATA128b *tmp,
                                 hiae_vaes_avx512_DATA128b M, int offset)
{
    tmp[offset] =
        hiae_vaes_avx512_SIMD_XOR(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
...
static inline hiae_vaes_avx512_DATA128b
hiae_vaes_avx512_enc_offset(hiae_vaes_avx512_DATA128b *state, hiae_vaes_avx512_DATA128b M,
                            int offset)
{
    hiae_vaes_avx512_DATA128b C =
        hiae_vaes_avx512_SIMD_XOR(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
...
static inline hiae_vaes_avx512_DATA128b
hiae_vaes_avx512_dec_offset(hiae_vaes_avx512_DATA128b *state, hiae_vaes_avx512_DATA128b *tmp,
                            hiae_vaes_avx512_DATA128b C, int offset)
{
    tmp[offset] =
        hiae_vaes_avx512_SIMD_XOR(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
...
#define hiae_vaes_avx512_LOAD_1BLOCK_offset_enc(M, offset) \
    (M) = hiae_vaes_avx512_SIMD_LOAD(mi + i + 0 + BLOCK_SIZE * offset);
#define hiae_vaes_avx512_LOAD_1BLOCK_offset_dec(C, offset) \
    (C) = hiae_vaes_avx512_SIMD_LOAD(ci + i + 0 + BLOCK_SIZE * offset);
#define hiae_vaes_avx512_LOAD_1BLOCK_offset_ad(M, offset) \
    (M) = hiae_vaes_avx512_SIMD_LOAD(ad + i + 0 + BLOCK_SIZE * offset);
#define hiae_vaes_avx512_STORE_1BLOCK_offset_enc(C, offset) \
    hiae_vaes_avx512_SIMD_STORE(ci + i + 0 + BLOCK_SIZE * offset, (C));
#define hiae_vaes_avx512_STORE_1BLOCK_offset_dec(M, offset) \
    hiae_vaes_avx512_SIMD_STORE(mi + i + 0 + BLOCK_SIZE * offset, (M));

static inline void hiae_vaes_avx512_state_shift(hiae_vaes_avx512_DATA128b *state)
{
...
static void HiAE_absorb_vaes(HiAE_state_t *state_opaque, const uint8_t *ad, size_t len)
{
    hiae_vaes_avx512_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t                    i      = 0;
...
static void HiAE_finalize_vaes(HiAE_state_t *state_opaque, uint64_t ad_len, uint64_t msg_len,
                               uint8_t *tag)
{
    hiae_vaes_avx512_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_enc_vaes(HiAE_state_t *state_opaque, uint8_t *ci, const uint8_t *mi, size_t size)
{
    hiae_vaes_avx512_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t rest   = size % UNROLL_BLOCK_SIZE;
...
static void HiAE_dec_vaes(HiAE_state_t *state_opaque, uint8_t *mi, const uint8_t *ci, size_t size)
{
    hiae_vaes_avx512_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t rest   = size % UNROLL_BLOCK_SIZE;
...
static void HiAE_enc_partial_noupdate_vaes(HiAE_state_t  *state_opaque,
                                           uint8_t       *ci,
                                           const uint8_t *mi,
                                           size_t         size)
{
...
static void HiAE_dec_partial_noupdate_vaes(HiAE_state_t  *state_opaque,
                                           uint8_t       *mi,
                                           const uint8_t *ci,
                                           size_t         size)
{
...
static int HiAE_encrypt_vaes(const uint8_t *key,
                             const uint8_t *nonce,
                             const uint8_t *msg,
                             uint8_t       *ct,
                             size_t         msg_len,
...
static int HiAE_decrypt_vaes(const uint8_t *key,
                             const uint8_t *nonce,
                             uint8_t       *msg,
                             const uint8_t *ct,
                             size_t         ct_len,
...
static int HiAE_mac_vaes(const uint8_t *key, const uint8_t *nonce, const uint8_t *data,
                         size_t data_len, uint8_t *tag)
{
    HiAE_state_t state;
    HiAE_init_vaes(&state, key, nonce);
...
static inline void hiae_arm_update_state_offset(hiae_arm_DATA128b *state, hiae_arm_DATA128b M,
                                                int offset)
{
    hiae_arm_DATA128b temp =
        hiae_arm_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    temp = hiae_arm_SIMD_XOR(temp, M);
    state[(0 + offset) % STATE] =
        hiae_arm_SIMD_XOR(temp, hiae_arm_AESL(state[(P_4 + offset) % STATE]));
...
static inline hiae_arm_DATA128b hiae_arm_keystream_block(hiae_arm_DATA128b *state,
                                                         hiae_arm_DATA128b M, int offset)
{
    M = hiae_arm_SIMD_XOR(
        M, hiae_arm_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]));
    M = hiae_arm_SIMD_XOR(M, state[(P_7 + offset) % STATE]);
    return M;
}

static inline hiae_arm_DATA128b hiae_arm_enc_offset(hiae_arm_DATA128b *state, hiae_arm_DATA128b M,
                                                    int offset)
{
    hiae_arm_DATA128b C =
        hiae_arm_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    ...
    state[(0 + offset) % STATE] =
        hiae_arm_SIMD_XOR(C, hiae_arm_AESL(state[(P_4 + offset) % STATE]));
...
static inline hiae_arm_DATA128b hiae_arm_dec_offset(hiae_arm_DATA128b *state,
                                                    hiae_arm_DATA128b *tmp, hiae_arm_DATA128b C,
                                                    int offset)
{
    ...
    state[(0 + offset) % STATE] =
        hiae_arm_SIMD_XOR(M, hiae_arm_AESL(state[(P_4 + offset) % STATE]));
...
#define hiae_arm_LOAD_1BLOCK_offset_enc(M, offset) \
    (M) = hiae_arm_SIMD_LOAD(mi + i + 0 + BLOCK_SIZE * offset);
#define hiae_arm_LOAD_1BLOCK_offset_dec(C, offset) \
    (C) = hiae_arm_SIMD_LOAD(ci + i + 0 + BLOCK_SIZE * offset);
#define hiae_arm_LOAD_1BLOCK_offset_ad(M, offset) \
    (M) = hiae_arm_SIMD_LOAD(ad + i + 0 + BLOCK_SIZE * offset);
#define hiae_arm_STORE_1BLOCK_offset_enc(C, offset) \
    hiae_arm_SIMD_STORE(ci + i + 0 + BLOCK_SIZE * offset, (C));
#define hiae_arm_STORE_1BLOCK_offset_dec(M, offset) \
    hiae_arm_SIMD_STORE(mi + i + 0 + BLOCK_SIZE * offset, (M));

static inline void hiae_arm_state_shift(hiae_arm_DATA128b *state)
{
...
static inline void hiae_arm_encrypt_chunk(hiae_arm_DATA128b *state, const uint8_t *mi, uint8_t *ci,
                                          size_t i)
{
...
static inline void hiae_arm_decrypt_chunk(hiae_arm_DATA128b *state, hiae_arm_DATA128b *tmp,
                                          const uint8_t *ci, uint8_t *mi, size_t i)
{
    hiae_arm_DATA128b M[16], C[16];
...
static void HiAE_init_arm(HiAE_state_t *state_opaque, const uint8_t *key, const uint8_t *nonce)
{
...
static void HiAE_absorb_arm(HiAE_state_t *state_opaque, const uint8_t *ad, size_t len)
{
    hiae_arm_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t            i      = 0;
...
static void HiAE_finalize_arm(HiAE_state_t *state_opaque, uint64_t ad_len, uint64_t msg_len,
                              uint8_t *tag)
{
    hiae_arm_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_enc_arm(HiAE_state_t *state_opaque, uint8_t *ci, const uint8_t *mi, size_t size)
{
    hiae_arm_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t rest   = size % UNROLL_BLOCK_SIZE;
...
static void HiAE_enc_partial_noupdate_arm(HiAE_state_t  *state_opaque,
                                          uint8_t       *ci,
                                          const uint8_t *mi,
                                          size_t         size)
{
...
static void HiAE_dec_partial_noupdate_arm(HiAE_state_t  *state_opaque,
                                          uint8_t       *mi,
                                          const uint8_t *ci,
                                          size_t         size)
{
...
static void HiAE_dec_arm(HiAE_state_t *state_opaque, uint8_t *mi, const uint8_t *ci, size_t size)
{
    hiae_arm_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t rest   = size % UNROLL_BLOCK_SIZE;
...
static int HiAE_encrypt_arm(const uint8_t *key,
                            const uint8_t *nonce,
                            const uint8_t *msg,
                            uint8_t       *ct,
                            size_t         msg_len,
...
static int HiAE_decrypt_arm(const uint8_t *key,
                            const uint8_t *nonce,
                            uint8_t       *msg,
                            const uint8_t *ct,
                            size_t         ct_len,
...
static int HiAE_mac_arm(const uint8_t *key, const uint8_t *nonce, const uint8_t *data,
                        size_t data_len, uint8_t *tag)
{
    HiAE_state_t state;
    HiAE_init_arm(&state, key, nonce);
...
#ifdef __clang__
#pragma clang attribute push(__attribute__((target("neon,crypto,aes,sha3"))), apply_to = function)
#elif defined(__GNUC__)
...
static inline void hiae_arm_sha3_update_state_offset(hiae_arm_sha3_DATA128b *state,
                                                     hiae_arm_sha3_DATA128b *tmp,
                                                     hiae_arm_sha3_DATA128b M, int offset)
{
    ...
    state[(0 + offset) % STATE] =
        hiae_arm_sha3_SIMD_XOR(tmp[offset], hiae_arm_sha3_AESL(state[(P_4 + offset) % STATE]));
...
{
    hiae_arm_sha3_DATA128b tmp =
        hiae_arm_sha3_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    M = hiae_arm_sha3_SIMD_XOR3(tmp, M, state[(P_7 + offset) % STATE]);
    return M;
}

static inline hiae_arm_sha3_DATA128b hiae_arm_sha3_enc_offset(hiae_arm_sha3_DATA128b *state,
                                                              hiae_arm_sha3_DATA128b M, int offset)
{
    hiae_arm_sha3_DATA128b C =
        hiae_arm_sha3_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    C = hiae_arm_sha3_SIMD_XOR(C, M);
    state[(0 + offset) % STATE] =
        hiae_arm_sha3_SIMD_XOR(C, hiae_arm_sha3_AESL(state[(P_4 + offset) % STATE]));
...
static inline hiae_arm_sha3_DATA128b hiae_arm_sha3_dec_offset(hiae_arm_sha3_DATA128b *state,
                                                              hiae_arm_sha3_DATA128b *tmp,
                                                              hiae_arm_sha3_DATA128b C, int offset)
{
    tmp[offset] = hiae_arm_sha3_XAESL(state[(P_0 + offset) % STATE], state[(P_1 + offset) % STATE]);
    hiae_arm_sha3_DATA128b M = hiae_arm_sha3_SIMD_XOR(state[(P_7 + offset) % STATE], C);
    state[(0 + offset) % STATE] =
        hiae_arm_sha3_SIMD_XOR(M, hiae_arm_sha3_AESL(state[(P_4 + offset) % STATE]));
...
#define hiae_arm_sha3_LOAD_1BLOCK_offset_enc(M, offset) \
    (M) = hiae_arm_sha3_SIMD_LOAD(mi + i + 0 + BLOCK_SIZE * offset);
#define hiae_arm_sha3_LOAD_1BLOCK_offset_dec(C, offset) \
    (C) = hiae_arm_sha3_SIMD_LOAD(ci + i + 0 + BLOCK_SIZE * offset);
#define hiae_arm_sha3_LOAD_1BLOCK_offset_ad(M, offset) \
    (M) = hiae_arm_sha3_SIMD_LOAD(ad + i + 0 + BLOCK_SIZE * offset);
#define hiae_arm_sha3_STORE_1BLOCK_offset_enc(C, offset) \
    hiae_arm_sha3_SIMD_STORE(ci + i + 0 + BLOCK_SIZE * offset, (C));
#define hiae_arm_sha3_STORE_1BLOCK_offset_dec(M, offset) \
    hiae_arm_sha3_SIMD_STORE(mi + i + 0 + BLOCK_SIZE * offset, (M));

static inline void hiae_arm_sha3_state_shift(hiae_arm_sha3_DATA128b *state)
{
...
static inline void hiae_arm_sha3_ad_update(hiae_arm_sha3_DATA128b *state,
                                           hiae_arm_sha3_DATA128b *tmp, const uint8_t *ad, size_t i)
{
...
static inline void hiae_arm_sha3_encrypt_chunk(hiae_arm_sha3_DATA128b *state, const uint8_t *mi,
                                               uint8_t *ci, size_t i)
{
...
static inline void hiae_arm_sha3_decrypt_chunk(hiae_arm_sha3_DATA128b *state,
                                               hiae_arm_sha3_DATA128b *tmp, const uint8_t *ci,
                                               uint8_t *mi, size_t i)
{
    hiae_arm_sha3_DATA128b M[16], C[16];
...
static void HiAE_init_arm_sha3(HiAE_state_t *state_opaque, const uint8_t *key, const uint8_t *nonce)
{
...
static void HiAE_absorb_arm_sha3(HiAE_state_t *state_opaque, const uint8_t *ad, size_t len)
{
    hiae_arm_sha3_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
    size_t                 i      = 0;
...
static void HiAE_finalize_arm_sha3(HiAE_state_t *state_opaque, uint64_t ad_len, uint64_t msg_len,
                                   uint8_t *tag)
{
    hiae_arm_sha3_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_enc_arm_sha3(HiAE_state_t *state_opaque, uint8_t *ci, const uint8_t *mi,
                              size_t size)
{
    hiae_arm_sha3_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_dec_arm_sha3(HiAE_state_t *state_opaque, uint8_t *mi, const uint8_t *ci,
                              size_t size)
{
    hiae_arm_sha3_DATA128b state[STATE];
    memcpy(state, state_opaque->opaque, sizeof(state));
...
static void HiAE_enc_partial_noupdate_arm_sha3(HiAE_state_t  *state_opaque,
                                               uint8_t       *ci,
                                               const uint8_t *mi,
                                               size_t         size)
{
...
static void HiAE_dec_partial_noupdate_arm_sha3(HiAE_state_t  *state_opaque,
                                               uint8_t       *mi,
                                               const uint8_t *ci,
                                               size_t         size)
{
...
static int HiAE_encrypt_arm_sha3(const uint8_t *key,
                                 const uint8_t *nonce,
                                 const uint8_t *msg,
                                 uint8_t       *ct,
                                 size_t         msg_len,
...
static int HiAE_decrypt_arm_sha3(const uint8_t *key,
                                 const uint8_t *nonce,
                                 uint8_t       *msg,
                                 const uint8_t *ct,
                                 size_t         ct_len,
...
static int HiAE_mac_arm_sha3(const uint8_t *key, const uint8_t *nonce, const uint8_t *data,
                             size_t data_len, uint8_t *tag)
{
    HiAE_state_t state;
    HiAE_init_arm_sha3(&state, key, nonce);
...
__attribute__((unused)) static inline int _have_feature(const char *feature)
{
...
static int _runtime_arm_cpu_features(CPUFeatures *const cpu_features)
{
#ifndef __ARM_ARCH
    return -1; /* LCOV_EXCL_LINE */
#endif
...
static int _runtime_powerpc_cpu_features(CPUFeatures *const cpu_features)
{
...
static int hiae_runtime_get_cpu_features(void)
{
    int ret = -1;
...
static HiAE_impl_t *hiae_get_impl_by_name(const char *name)
{
    if (name == NULL) {
        return NULL;
    }
...
static void hiae_init_dispatch(void)
{
    if (hiae_impl != NULL) {
...
static void _do_HiAE_init_library(void)
{
...
int HiAE_encrypt(const uint8_t *key,
                 const uint8_t *nonce,
                 const uint8_t *msg,
                 uint8_t       *ct,
                 size_t         msg_len,
...
int HiAE_decrypt(const uint8_t *key,
                 const uint8_t *nonce,
                 uint8_t       *msg,
                 const uint8_t *ct,
                 size_t         ct_len,
